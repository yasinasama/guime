...
class UI(wx.Frame):
    ...
    def __init__(self,):
        super(UI, self).__init__(None,style=wx.MAXIMIZE |wx.DEFAULT_FRAME_STYLE)
    ...
    def __init(self):
        ...
        main_box.SetEmptyCellSize((110, 20))

        new_btn = wx.Button(self.panel, -1, "新建")
        main_box.Add(new_btn,pos=(0,0), flag=wx.ALL,border=5)

        search_btn = wx.Button(self.panel, -1, "查询")
        main_box.Add(search_btn,pos=(0,1), flag=wx.ALL,border=5)

        search_btn.Bind(wx.EVT_BUTTON,self.search_btn_click)
        
        st_order_id = wx.StaticText(self.panel, label="结算单号: ",style=wx.ALIGN_LEFT)
        main_box.Add(st_order_id,pos=(1,0), flag=wx.TOP|wx.BOTTOM|wx.LEFT,border=10)
        tc_order_id = wx.TextCtrl(self.panel)
        main_box.Add(tc_order_id,pos=(1,1), span=(1,2), flag=wx.EXPAND|wx.TOP|wx.BOTTOM,border=10)
        self.tcs['order_id'] = tc_order_id

        st_car_frame = wx.StaticText(self.panel, label="车架号: ", style=wx.ALIGN_LEFT)
        main_box.Add(st_car_frame, pos=(1, 3), flag=wx.TOP | wx.BOTTOM | wx.LEFT, border=10)
        tc_car_frame = wx.TextCtrl(self.panel)
        main_box.Add(tc_car_frame, pos=(1, 4), span=(1, 3), flag=wx.EXPAND|wx.TOP | wx.BOTTOM, border=10)
        self.tcs['car_frame'] = tc_car_frame

        st_order_time = wx.StaticText(self.panel, label="开单时间: ", style=wx.ALIGN_LEFT)
        main_box.Add(st_order_time, pos=(1,7), flag=wx.TOP|wx.BOTTOM|wx.LEFT,border=10)
        tc_order_time = wx.TextCtrl(self.panel)
        main_box.Add(tc_order_time, pos=(1,8), span=(1,3), flag=wx.EXPAND|wx.TOP|wx.BOTTOM,border=10)
        self.tcs['order_time'] = tc_order_time

        st_car_id = wx.StaticText(self.panel, label="车牌号: ", style=wx.ALIGN_LEFT)
        main_box.Add(st_car_id, pos=(2,0), flag=wx.TOP|wx.BOTTOM|wx.LEFT,border=10)
        tc_car_id = wx.TextCtrl(self.panel)
        main_box.Add(tc_car_id, pos=(2,1), span=(1,2), flag=wx.EXPAND|wx.TOP|wx.BOTTOM,border=10)
        self.tcs['car_id'] = tc_car_id

        st_car_type = wx.StaticText(self.panel, label="车型: ", style=wx.ALIGN_LEFT)
        main_box.Add(st_car_type, pos=(2,3), flag=wx.TOP|wx.BOTTOM|wx.LEFT,border=10)
        tc_car_type = wx.TextCtrl(self.panel)
        main_box.Add(tc_car_type, pos=(2,4), span=(1,2), flag=wx.EXPAND|wx.TOP|wx.BOTTOM,border=10)
        self.tcs['car_type'] = tc_car_type



        st_car_owner = wx.StaticText(self.panel, label="车主: ", style=wx.ALIGN_LEFT)
        main_box.Add(st_car_owner, pos=(3, 0), flag=wx.TOP | wx.BOTTOM | wx.LEFT, border=10)
        tc_car_owner = wx.TextCtrl(self.panel)
        main_box.Add(tc_car_owner, pos=(3, 1), span=(1, 2), flag=wx.EXPAND|wx.TOP | wx.BOTTOM, border=10)
        self.tcs['car_owner'] = tc_car_owner


        st_phone = wx.StaticText(self.panel, label="联系电话: ", style=wx.ALIGN_LEFT, )
        main_box.Add(st_phone, pos=(3, 3), flag=wx.TOP | wx.BOTTOM | wx.LEFT, border=10)
        tc_phone = wx.TextCtrl(self.panel)
        main_box.Add(tc_phone, pos=(3, 4), span=(1, 2), flag=wx.EXPAND|wx.TOP | wx.BOTTOM, border=10)
        self.tcs['phone'] = tc_phone


        st_remark = wx.StaticText(self.panel, label="备注: ", style=wx.ALIGN_LEFT)
        main_box.Add(st_remark,pos=(2,6), flag=wx.ALL,border=10)
        tc_remark = wx.TextCtrl(self.panel,style=wx.TE_MULTILINE)
        main_box.Add(tc_remark,pos=(2,7), span=(2,4), flag=wx.EXPAND|wx.TOP|wx.BOTTOM,border=10)
        ...
        main_box.Add(self.lc,pos=(5,0), span=(24,15), flag=wx.EXPAND |wx.ALL,border=10)
        #
        # self.lc2 = wx.ListCtrl(self.panel, 0, style=wx.LC_REPORT | wx.EXPAND)
        # columns2 = [
        #     '维修单号',
        #     '维修项目',
        #     '零件费',
        ...
        # main_box.Add(self.lc2, pos=(5, 11), span=(10,5), flag=wx.EXPAND |wx.BOTTOM | wx.LEFT, border=10)

        # # size
        main_box.AddGrowableCol(14)
...
def main():
    ...
    app = wx.App()
    ex = UI()
    ex.set_values([['1','2','33333333111111111111122132134123413412341341sssssss','4','5','6','7','8','9']]*20)
    ex.show()
    app.MainLoop()
